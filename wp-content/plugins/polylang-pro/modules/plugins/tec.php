...
class PLL_TEC {
	...
	public function reset_slugs() {
		...
		self::$slugs = array(
			...
			'tag_slug'       => 'tag',
			'taxRewriteSlug' => $tec->rewriteSlug . '/category', // PHPCS:ignore WordPress.NamingConventions.ValidVariableName.NotSnakeCaseMemberVar
			'tagRewriteSlug' => $tec->rewriteSlug . '/tag', // PHPCS:ignore WordPress.NamingConventions.ValidVariableName.NotSnakeCaseMemberVar
			'monthSlug'      => 'month',
			'listSlug'       => 'list',
